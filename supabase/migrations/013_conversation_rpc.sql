-- 013: RPC function for efficient conversation list
-- Returns conversations with last message + unread count in a single query
-- (avoids N+1 queries from the API layer)
