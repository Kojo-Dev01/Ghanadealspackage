      ...
      <section className="bg-panel border border-border rounded-xl p-5 shadow-sm">
        ...
        <ul className="grid gap-2 text-sm text-muted">
          <li className="flex items-start gap-2">
            ...
            <span>
              <strong>National ID (Ghana Card)</strong> — A clear photo or scan
              of your Ghana Card, passport, or voter's ID.
            </span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-accent font-bold">2.</span>
            <span>
              <strong>Business Registration</strong> — Your company registration
              certificate or sole proprietorship permit (if applicable).
            </span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-accent font-bold">3.</span>
            <span>
              <strong>Proof of Address</strong> — A recent utility bill or bank
              statement showing your business address.
            </span>
          </li>
        </ul>
      </section>
